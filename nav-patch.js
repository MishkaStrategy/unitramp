document.addEventListener('DOMContentLoaded',()=>{
  if(!document.querySelector('style[data-unitramp-responsive-fix]')){
    ...
    style.textContent='@media(max-width:1180px){.mega{display:none!important}}@media(max-width:820px){.hero-bottom>*,.section-head>*,.cta-grid>*,.contact-grid>*,.park-builder>*,.footer-grid>*,.toolbar>*,.project-index-grid>*,.solution-grid>*,.article-grid>*{min-width:0}.project-index-card,.solution-card,.article-card,.product-card{min-width:0;max-width:100%}.section-head h2,.page-hero h1,.turnkey-copy h1,.project-index-card h2,.solution-card h3,.article-card h2,.cta-grid h2{hyphens:auto;overflow-wrap:anywhere}.project-meta>*{min-width:0;overflow-wrap:anywhere}.product-actions{flex-wrap:wrap}.filter-chip,.cat-pill{max-width:calc(100vw - 48px);white-space:normal;overflow-wrap:anywhere}}@media(max-width:520px){.hero h1{font-size:clamp(35px,11vw,50px)}.toolbar>*{max-width:100%;min-width:0}.btn{max-width:100%;white-space:normal;text-align:center}}';
